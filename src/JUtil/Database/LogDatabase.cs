...
namespace JUtil
{
    ...
    /// LogDatabase
    /// </summary>
    public class LogDatabase : IDbBasicOp
    {
        public delegate string fpGetPostmark();

        private readonly IDbBasicOp db;
        ...
        /// </summary>
        /// <param name="db"></param>
        /// <param name="sqlLogMode"></param>
        /// <param name="GetPostmark">設定額外Log的資訊</param>
        public LogDatabase(IDbBasicOp db, eSqlLogMode sqlLogMode, fpGetPostmark GetPostmark)
        {
            this.db = db;
        ...
        public LogDatabase(IDbBasicOp db, eSqlLogMode sqlLogMode)
        {
            this.db = db;
