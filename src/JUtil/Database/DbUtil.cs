...
namespace JUtil
{
    public class DbUtil
    {
        ...
        public static IDatabase GetHoldingConnectionDb(DbConnectionConfig DbConnectionConfig)
        {
            return new Database(DbConnectionConfig);
        }
        ...
        public List<string> GetTables()
        {
            try
            {
                ...
                {
                    ConnectionStringParser parser = new ConnectionStringParser(db.DbConnectionConfig);
