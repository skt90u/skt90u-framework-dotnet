...
namespace JUtil.Reflection
{
    ...
    public class Reflect
    {
        ...
        /// <param name="inherit">True to include inherited attributes</param>
        /// <returns>The attribute or null</returns>
        public static System.Attribute[] GetAttributes(ICustomAttributeProvider member, string attrName, bool inherit)
        {
        ...
        /// <param name="inherit">True to include inherited attributes</param>
        /// <returns>The attribute or null</returns>
        public static System.Attribute[] GetAttributes(ICustomAttributeProvider member, bool inherit)
        {
            ...
            {
                result[System.Math.Max(System.Threading.Interlocked.Increment(ref n), n - 1)] = attribute;
            }
        ...
        {
            Type current = type;
            while (!object.ReferenceEquals(current, typeof(object)))
            {
        ...
        /// <summary>
        /// determine an object is inherit form a type
        /// </summary>
        ...
        private class BaseTypesFirstComparer : IComparer
        {
            ...
            public int Compare(object x, object y)
            {
                ...
                if (object.ReferenceEquals(m1Type, m2Type))
                {
                    return 0;
                }
                if (m1Type.IsAssignableFrom(m2Type))
                {
                    return -1;
                }
        ...
        /// <summary>
        /// get the field value of an object according to its fieldName
        /// </summary>
        /// <param name="obj"></param>
        /// <param name="name"></param>
        /// <returns></returns>
        ...
        {
            return GetFieldValue(obj, name, BindingFlags.Public | BindingFlags.Instance);
        }

        /// <summary>
        /// get the field value of an object according to its fieldName and its accessibility
        /// </summary>
        /// <param name="obj"></param>
        /// <param name="name"></param>
        /// <param name="bindingFlags"></param>
        /// <returns></returns>
        public static object GetFieldValue(object obj, string name, BindingFlags bindingFlags)
        {
            FieldInfo fieldInfo = GetNamedField(obj.GetType(), name, bindingFlags);
            if (fieldInfo != null)
            {
        ...
        /// <summary>
        /// get FieldInfo of a type according to its name and accessibility
        /// </summary>
        /// <param name="type"></param>
        /// <param name="name"></param>
        /// <param name="bindingFlags"></param>
        /// <returns></returns>
        public static FieldInfo GetNamedField(Type type, string name, BindingFlags bindingFlags)
        {
        ...
        public static object Construct(Type type)
        {
            ...
            if (ctor == null)
            {
                throw new ArgumentNullException(type.FullName + " does not have a default constructor");
            }
        ...
        public static Type[] GetTypeArray(object[] objects)
        {
            ...
            {
                types[System.Math.Max(System.Threading.Interlocked.Increment(ref index), index - 1)] = o == null ? null : o.GetType();
            }
            return types;
        }
        ...
        /// <param name="method">A MethodInfo for the method to be invoked</param>
        /// <param name="fixture">The object on which to invoke the method</param>
        /// <param name="args">argument of callee</param>
        /// <returns></returns>
        ...
        /// </summary>
        public static object InvokeMethod(string methodName, object fixture, params object[] args)
        {
            Type t = fixture.GetType();
        ...
        {
            return InvokeStaticMethod(typeof (T), methodName, args);
        }
        ...
        public static List<Type> GetTypeContainAttribute<AttributeT>(Assembly assembly)
        {
            ...
            foreach (Type type in types)
            {
                AttributeT[] attributes = 
                    type.GetCustomAttributes(typeof(AttributeT), false) as AttributeT[];
