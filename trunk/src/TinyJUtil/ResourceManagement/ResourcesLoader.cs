...
namespace TinyJUtil.ResourceManagement
{
    /// <summary>
    /// 指定解析resourceId的方式
    /// </summary>
    ...
    {
        public static string GetResourceId(Assembly assembly, string resourceFilename)
        {
            ...
            return GetResourceId(matchName);
        }
        ...
        {
            resourceIdPolicy = Environment.IsWebApplication ? ResourceIdPolicy.FullResourceName : ResourceIdPolicy.FileName;
        }
        ...
        /// 載入指定assembly路徑的內嵌資源
        /// </summary>
        public ResourcesLoader(Assembly assem) : this(assem.Location){}

        /// <summary>
        /// 載入目前assembly路徑的內嵌資源
        /// </summary>
        public ResourcesLoader() :this(System.Reflection.Assembly.GetExecutingAssembly().Location){}
